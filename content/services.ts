...
export const services: Service[] = [
  {
    ...
    description:
      "Private guided tours across the island — history, culture, nature and hidden gems, at your own pace with a driver-guide who knows Mauritius intimately. Every tour is priced per vehicle, so the whole group travels for one fare.",
    icon: "route",
    href: "/tours",
    bullets: [
      "Driver-guides speaking English, French, Hindi, Urdu and Arabic",
      "Private air-conditioned vehicle, hotel pickup and drop-off",
      "Priced per vehicle, not per person",
      "Half-day and full-day routes across the island",
    ],
    cta: "Explore Tours",
    priority: 1,
  },
  {
    ...
    description:
      "Private transfers to and from your hotel, between resorts, or to any address in Mauritius. Your driver is waiting when you land — no queues, no haggling, no shared passengers and no unnecessary stops.",
    icon: "car",
    href: "/airport-transfers",
    bullets: [
      "Met in arrivals once you have collected your luggage",
      "Pickup from any address in Mauritius, hotel to hotel included",
      "Air-conditioned vehicle reserved exclusively for your group",
      "Fixed price per vehicle, confirmed before you travel",
    ],
